...
public class DateTickUnit extends TickUnit implements Serializable {
     ...
     *
     * @deprecated As of JFreeChart version 1.0.13, use {@link DateTickUnitType} instead.
     */
     ...
     *
     * @deprecated As of JFreeChart version 1.0.13, use {@link #DateTickUnit(
     ...
     *
     * @deprecated As of JFreeChart 1.0.13, use the getUnitType() method.
     */
    public int getUnit() {
        return this.unit;
    }
     ...
     *
     * @deprecated As of JFreeChart version 1.0.13, use {@link #getMultiple()}.
     */
    public int getCount() {
        return this.count;
    }
