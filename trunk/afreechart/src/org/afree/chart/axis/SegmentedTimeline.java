...
public class SegmentedTimeline implements Timeline, Cloneable, Serializable {
     ...
     * constant.
     *
     * @deprecated As of JFreeChart 1.0.7.  This field doesn't take into account changes
     ...
     *
     * @deprecated As of JFreeChart 1.0.7.  This field is initialised based on the
