...
public class AbstractBlock implements Cloneable, Serializable {
     ...
     */
    private transient RectShape bounds;
    ...
    public Size2D arrange(Canvas canvas) {
        return arrange(canvas, RectangleConstraint.NONE);
    }
     ...
     */
    protected RectShape trimMargin(RectShape area) {
     ...
     * @return The trimmed area.
     */
    protected RectShape trimBorder(RectShape area) {
        // defer argument checking...
     ...
     * @return The trimmed area.
     */
    protected RectShape trimPadding(RectShape area) {
        // defer argument checking...
     ...
     *            the area.
     */
    protected void drawBorder(Canvas canvas, RectShape area) {
        this.frame.draw(canvas, area);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        clone.bounds = (RectShape) ShapeUtilities.clone(this.bounds);
