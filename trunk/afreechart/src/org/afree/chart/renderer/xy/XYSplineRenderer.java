 ...
 * <code>XYSplineRendererDemo1.java</code> program included in the AFreeChart
 * demo collection:
 * <br><br>
...
public class XYSplineRenderer extends XYLineAndShapeRenderer {
    ...
    public XYItemRendererState initialise(Canvas canvas, RectShape dataArea,
        ...
        State state = (State) super.initialise(canvas, dataArea, plot, data, info);
    ...
    protected void drawPrimaryLineAsPath(XYItemRendererState state,
            Canvas canvas, XYPlot plot, XYDataset dataset, int pass,
